...
<div class="container">
    ...
    <header class="col-lg-12">
        ...
        <div class="col-lg-12">
            <a href="${pageContext.request.contextPath}/departement/add" id="space" class="btn btn-primary">Ajouter departement</a>
            <br/>
        </div>
        <table class="table table-bordered">
            ...
            <c:forEach items="${pageable.content}" var="item">
                <tr>
                    <td>${item.id}</td>
                    <td>
                        <a href="${pageContext.request.contextPath}/departement/view/${item.id}">
                                ${item.dname}</a></td>
                    <td>${item.type}</td>
            ...
            <ul class="pagination">
                <c:choose>
                    <c:when test="${pageable.number !=0 }">
                        <li class="page-item">
                            <a class="page-link"
                               href="${pageContext.request.contextPath}/departement/page/${pageable.number-1 }">
                                Previous</a></li>
                    </c:when>
                </c:choose>
